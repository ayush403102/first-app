...
// throw new Error('Not Today!')
  return (
    ...
    <header>
    <h1 className="mb-4 text-3xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 place-content-center flex">Know About Us</h1>

    </header>

<section class="overflow-hidden pt-10 pb-6 lg:pt-[60px] lg:pb-[90px] lg:mx-10">
